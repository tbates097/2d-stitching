function data = A3200Acc2DMultiZone_test(InputFile, CalFile, OutAxis3, OutAx3Value, Units)
...
% --- Debug dump: save per-zone processed matrices and metadata ---
try
    [~, base, ~] = fileparts(InputFile);
    debug_file = sprintf('%s_zone_debug.mat', base);
    save(debug_file, 'X','Y','Ax1Err','Ax2Err', ...
         'Ax1Coef','Ax2Coef','Ax1Line','Ax2Line', ...
         'UserUnit','calDivisor','Ax1Num','Ax2Num','Ax1SampDist','Ax2SampDist');
catch ME
    try
        warning('Debug dump failed in A3200Acc2DMultiZone_test: %s', ME.message);
    catch
    end
end
