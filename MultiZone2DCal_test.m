...
% --- Debug dump: save stitched/finalized matrices and cal tables (if available) ---
try
    vars = {'X','Y','Ax1Err','Ax2Err','NumAx1Points','NumAx2Points', ...
            'Ax1Coef','Ax2Coef','Ax1Line','Ax2Line','UserUnit','calDivisor', ...
            'Ax1Num','Ax2Num','Ax1SampDist','Ax2SampDist'};
    save('matlab_multizone_debug.mat', vars{:});
    if exist('Ax1cal','var') && exist('Ax2cal','var')
        save('matlab_multizone_debug.mat','Ax1cal','Ax2cal','-append');
    end
catch ME
    try
        warning('Debug dump failed in MultiZone2DCal_test: %s', ME.message);
    catch
    end
end
